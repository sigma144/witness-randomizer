...
enum PanelVar : int {
	...
	ERASER_ACTIVE = 0x308, //int
	ERASER_FADE_T = 0x30C, //float
	ERASER_TIME_TO_REJUDGE = 0x310, //float
	NUM_ERASED_DECORATIONS = 0x318, //int
	ERASED_DECORATIONS_LEN = 0x31C, //int
	ERASED_DECORATIONS = 0x320, //int[]
	NUM_ERASED_DOTS = 0x328, //int
	ERASED_DOTS_LEN = 0x32C, //int
	ERASED_DOTS = 0x330, //int[]
	PATTERN_SCALE = 0x338,
