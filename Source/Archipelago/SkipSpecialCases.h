...
inline const std::map<int, std::vector<int>> skipTogether = {
	...
	{ 0x00CB9, { 0x00CB9, 0x00CA1, 0x00C80 } }, // Challenge triplets
	{ 0x00CA1, { 0x00CB9, 0x00CA1, 0x00C80 } },
	{ 0x00C80, { 0x00CB9, 0x00CA1, 0x00C80 } },

	{ 0x00C68, { 0x00C68, 0x00C59, 0x00C22 } }, // Challenge triplets
	{ 0x00C59, { 0x00C68, 0x00C59, 0x00C22 } },
	{ 0x00C22, { 0x00C68, 0x00C59, 0x00C22 } },
};
