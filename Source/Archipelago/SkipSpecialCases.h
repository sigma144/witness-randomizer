...
inline const std::map<int, std::vector<int>> collectTogether = {
	...
	{ 0x014D1, { 0x00001, 0x014D2, 0x014D4 }}, // Swamp Red Underwater
	{ 0x09FD2, { 0x09FCC, 0x09FCE, 0x09FCF, 0x09FD0, 0x09FD1 }}, // Mountain Floor 2 Multipanel
	{ 0x034E3, { 0x034E4 }}, // Sound Room
