...
inline std::map<int, std::pair<Vector3, float>> easterEggs = {
	...
	// Orchard 2
	{ 0xEE008, {{-104.46, 25.2631, 17.149}, 0.5f}}, // Wedged under Table, Rever

	// Glass Factory
	{ 0xEE009, {{-197.448, -35.103, 1.306}, 0.8f}}, // Glass Factory Furnace, Exempt-Medic
	...
	{ 0xEE00F, {{-125.541, 67.34, 15.211}, 3.0f}}, // Sand Snake EP Tree, Scipio
	{ 0xEE010, {{-122.259, 86.258, 12.839}, 3.0f}}, // Desert Laser "Air Hole", Scipio
	{ 0xEE011, {{-88.7798, 193.946, 20.9679}, 4.0f}}, // Desert Perspective Tree, Scipio
	{ 0xEE012, {{-108.916, 207.97, 0.415998}, 4.0f}}, // Desert Shore Near Perspective Tree, Rever
	{ 0xEE013, {{-201.321, 238.077, 0.648001}, 0.5f}}, // Desert Shore Right, NewSoupVi

	// Desert Vault
	{ 0xEE014, {{-230.669, 199.455, 0.852001}, 0.55f}}, // Desert Vault, NewSoupVi

	// Desert Pond Room
	{ 0xEE015, {{-164.225, 163.973, -0.683999}, 1.0f}}, // Staircase to Pond Room, NewSoupVi
	{ 0xEE016, {{-180.825, 165.418, -3.31}, 1.0f}}, // Pond Room, NewSoupVi

	// Desert Flood Room
	{ 0xEE017, {{-180.579, 166.568, -9.46402}, 0.8f}}, // Flood Room EP, Rever

	// Desert Elevator Room
	{ 0xEE018, {{-147.136, 129.896, -7.148}, 0.6f}}, // Elev Room Behind Bent 3, NewSoupVi

	// Outside Quarry
	{ 0xEE019, {{-70.556, 184.644, 11.943}, 12.0f}}, // Rooftop Path near Desert Perspective Tree Dead End, NewSoupVi
	{ 0xEE01A, {{-56.535, 97.754, 12.149}, 14.0f}}, // Rooftop Path near Laser Dead End, NewSoupVi
	...
	{ 0xEE023, {{-69.412, 133.404, 4.419}, 0.15f}}, // Quarry Stoneworks Furnace Inside, NewSoupVi
	{ 0xEE0FF, {{-63.958, 133.729, 2.01}, 0.14f}}, // The meanest egg to ever exist, Rever

	// Shadows
	{ 0xEE024, {{-9.02006, 88.7752, 13.46}, 5.0f}}, // Near Butterfly Tree, Exempt-Medic
	...
	// Keep Hedge Maze 3
	{ 0xEE029, {{45.042, 94.549, 19.171}, 10.0f}}, // Keep Hedge 3 Hole, NewSoupVi
	{ 0xEE02A, {{43.05, 82.9641, 19.7891}, 2.0f}}, // Keep Hedge 3 Wall Cubby, NewSoupVi
	{ 0xEE02B, {{20.574, 91.622, 21.911}, 2.0f}}, // Keep SW Tower, NewSoupVi

	// Keep Pressure Plates 2
	{ 0xEE02C, {{68.464, 189.053, 20.3061}, 2.0f}}, // PP2 Broken Wall, NewSoupVi
	{ 0xEE02D, {{65.588, 184.168, 22.756}, 4.0f}}, // PP2->PP3 Walkable Wall, NewSoupVi

	// Keep Pressure Plates 3
	{ 0xEE02E, {{50.212, 184.124, 16.395}, 6.0f}}, // Keep PP3 Hand Guy, NewSoupVi

	// Keep Pressure Plates 4
	{ 0xEE02F, {{55.794, 163.02, 17.4661}, 2.0f}}, // Keep PP4 Hand Guy, Rever

	// Keep Tower
	{ 0xEE030, {{31.071, 142.541, 22.764}, 1.2f}}, // Keep Center West Tower, Exempt-Medic
	{ 0xEE031, {{53.061, 145.743, 33.222}, 1.0f}}, // Keep Tower Shooty Hole, NewSoupVi

	// Shipwreck
	{ 0xEE032, {{108.048, 209.634, 10.2499}, 0.3f}}, // Shipwreck Under Entrance, NewSoupVi
	{ 0xEE033, {{115.119, 214.291, 9.41693}, 0.7f}}, // In weird long hole thing, NewSoupVi
	{ 0xEE034, {{177.602, 205.27, 0.873}, 0.12f}}, // Bottom Floor Dead End, NewSoupVi
	{ 0xEE035, {{178.018, 204.497, 2.27301}, 3.0f}}, // Abandoned Staircase, Exempt-Medic
	{ 0xEE036, {{190.402, 203.267, 3.449}, 4.0f}}, // Behind Stern, NewSoupVi
	...
	// Town
	{ 0xEE03A, {{-10.239, 64.711, 8.98798}, 2.0f}}, // Progress Lake, NewSoupVi
	{ 0xEE03B, {{-9.66801, -19.212, 11.21}, 0.15f}}, // Under Town Maze Stairs, Exempt-Medic
	{ 0xEE03C, {{-26.2322, -26.356, 10.188}, 0.17f}}, // Town Brick Furnace, NewSoupVi
	{ 0xEE03D, {{-64.456, -8.16704, 9.65603}, 1.0f}}, // Town Hole, Scipio
	...
	// Town Tower 4th
	{ 0xEE042, {{-41.219, -12.284, 22.861}, 0.76f}}, // Under Town Laser, Rever

	// Windmill
	{ 0xEE043, {{-92.465, 27.214, 12.699}, 0.4f}}, // Windmill Behind Entry Door, Scipio
	{ 0xEE044, {{-93.733, 27.764, 7.16801}, 0.54f}}, // Windmill Staircase, NewSoupVi

	// Theater
	{ 0xEE045, {{-68.084, -4.291, -1.191}, 0.17f}}, // Theater, Rever

	// Jungle
	{ 0xEE046, {{-11.7705, -117.198, 0.141}, 0.5f}}, // Peninsula Shore, NewSoupVi
	{ 0xEE047, {{0.083, -153.61, 0.697999}, 10.0f}}, // Peninsula Glass, NewSoupVi
	{ 0xEE048, {{-20.894, -138.558, 1.163}, 0.5f}}, // Peninsula Dead End, Scipio
	{ 0xEE049, {{-44.4687, -155.232, 0.529006}, 0.84f}}, // Peninsula Dead End Right, NewSoupVi
	...
	{ 0xEE04D, {{57.877, -56.289, 19.314}, 0.62f}}, // Under Popup Wall, Exempt-Medic

	// Jungle Vault
	{ 0xEE04E, {{49.991, -70.988, 9.02993}, 0.33f} }, // Jungle Vault, NewSoupVi
	...
	{ 0xEE059, {{134.658, 48.614, -3.16699}, 0.47f}}, // Cyan Underwater Corner, Scipio

	// Swamp Beyond Bridge
	{ 0xEE05A, {{207.84, 7.99, 2.482}, 3.0f}}, // Cage, Scipio

	// Swamp 
	{ 0xEE05B, {{146.63, 17.653, 0.304}, 6.0f}}, // Behind Red Maze, Scipio
	...
	{ 0xEE05F, {{117.915, 142.597, 16.746}, 0.18f}}, // Timer Platform Corner, NewSoupVi

	// Treehouse Second Purple Bridge
	{ 0xEE060, {{134.06, 118.917, 15.183}, 2.0f}}, // Between Purple Bridges Stairs House, NewSoupVi

	// Treehouse Green Bridge Left House
	{ 0xEE061, {{125.683, 159.287, 16.526}, 0.37f}}, // Plank near Right Bridge EP, NewSoupVi

	// Treehouse Laser Room Back Platform
	{ 0xEE062, {{107.055, 133.771, 19.626}, 2.0f} }, // Treehouse Laser House Roof, hatkirby
	...
	{ 0xEE06D, {{204.421, -41.8059, 0.757003}, 5.0f}}, // Final Room Statue, NewSoupVi
	...
	{ 0xEE073, {{1.595, -40.682, -5.43099}, 0.52f}}, // Challenge behind 2nd reallocating, NewSoupVi

	// Tunnels
	{ 0xEE074, {{-98.745, 45.942, -3.16899}, 1.0f}}, // Walkway ontop of lamp, NewSoupVi
