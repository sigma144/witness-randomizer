...
const int ITEM_COLORED_SQUARES = ITEM_SQUARES + 1;
const int ITEM_ARROWS = ITEM_OFFSET + 80;

//Powerups
const int ITEM_TEMP_SPEED_BOOST = ITEM_OFFSET + 90;

//Traps
const int ITEM_TEMP_SPEED_REDUCTION = ITEM_OFFSET + 95;
const int ITEM_POWER_SURGE = ITEM_OFFSET + 96;
