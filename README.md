...
This project was originally started by [NewSoupVi](https://github.com/newsoupvi) and continued by [Jarno](https://github.com/Jarno458). Additional contributions have been made by [blastron](https://github.com/blastron), [hatkirby](https://github.com/hatkirby), and [Quas-NaArt](https://github.com/Quas-NaArt). [OddGarrett](https://github.com/gareth) wrote some words.
